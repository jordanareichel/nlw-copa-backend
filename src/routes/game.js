    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            fastify.get("/pools/:id/games", {
                ...
                var getPoolGamesParams, id, games;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            getPoolGamesParams = zod_1.z.object({
                                id: zod_1.z.string()
                            });
                            id = getPoolGamesParams.parse(request.params).id;
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, {
                                    games: games.map(function (game) {
                                        return __assign(__assign({}, game), { guess: game.guesses.length > 0 ? game.guesses[0] : null, guesses: undefined });
                                    })
                                }];
                    }
                });

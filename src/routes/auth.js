    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            fastify.get("/me", {
                ...
                return __generator(this, function (_a) {
                    return [2 /*return*/, { user: request.user }];
                });
            }); });
            fastify.post("/users", function (request) { return __awaiter(_this, void 0, void 0, function () {
                var createUserBody, access_token, userResponse, userData, userInfoScheme, userInfo, user, token;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, (0, node_fetch_1["default"])('https://www.googleapis.com/oauth2/v2/userinfo', {
                                    method: 'GET',
                                    headers: {
                        ...
                        case 2:
                            ...
                            userInfoScheme = zod_1.z.object({
                                id: zod_1.z.string(),
                                email: zod_1.z.string().email(),
                                name: zod_1.z.string(),
                                picture: zod_1.z.string().url()
                            });
                            userInfo = userInfoScheme.parse(userData);
